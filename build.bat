...
cmake -S "D:\opencode\autoflow-cpp" -B "D:\opencode\autoflow-cpp\build" -G Ninja -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH="C:\Qt\6.8.3\msvc2022_64" %*
if errorlevel 1 exit /b 1
cmake --build "D:\opencode\autoflow-cpp\build"
exit /b %errorlevel%
