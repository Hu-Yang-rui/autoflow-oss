...
QString selectDisplayText(const std::string& option) {
    static const QHash<QString, QString> zh = {
        ...
        // 按键键名 → 中文
        {QStringLiteral("space"),       QStringLiteral("空格")},
        {QStringLiteral("enter"),       QStringLiteral("回车")},
        {QStringLiteral("tab"),         QStringLiteral("制表")},
        {QStringLiteral("backspace"),   QStringLiteral("退格")},
        {QStringLiteral("delete"),      QStringLiteral("删除")},
        {QStringLiteral("up"),          QStringLiteral("↑ 上")},
        {QStringLiteral("down"),        QStringLiteral("↓ 下")},
        {QStringLiteral("home"),        QStringLiteral("主页")},
        {QStringLiteral("end"),         QStringLiteral("结束")},
        {QStringLiteral("pageup"),      QStringLiteral("上页")},
        {QStringLiteral("pagedown"),    QStringLiteral("下页")},
        {QStringLiteral("insert"),      QStringLiteral("插入")},
        {QStringLiteral("capslock"),    QStringLiteral("大写锁定")},
        {QStringLiteral("esc"),         QStringLiteral("退出")},
        {QStringLiteral("printscreen"), QStringLiteral("截屏")},
        {QStringLiteral("scrolllock"),  QStringLiteral("滚动锁定")},
        {QStringLiteral("pause"),       QStringLiteral("暂停")},
        {QStringLiteral("apps"),        QStringLiteral("应用键")},
        {QStringLiteral("f1"),   QStringLiteral("F1")},
        {QStringLiteral("f2"),   QStringLiteral("F2")},
        {QStringLiteral("f3"),   QStringLiteral("F3")},
        {QStringLiteral("f4"),   QStringLiteral("F4")},
        {QStringLiteral("f5"),   QStringLiteral("F5")},
        {QStringLiteral("f6"),   QStringLiteral("F6")},
        {QStringLiteral("f7"),   QStringLiteral("F7")},
        {QStringLiteral("f8"),   QStringLiteral("F8")},
        {QStringLiteral("f9"),   QStringLiteral("F9")},
        {QStringLiteral("f10"),  QStringLiteral("F10")},
        {QStringLiteral("f11"),  QStringLiteral("F11")},
        {QStringLiteral("f12"),  QStringLiteral("F12")},
    };
